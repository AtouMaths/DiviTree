            ...
            if self.db in ["EPODOC", "DOCDB"]:
                ...
                for i in range(len(df), 0, -1):
                    ...
                    if i-1 < len(df) and prior_row['app_number'] is not None:                    
                        ...
                        # Make it a root ONLY if no parent OR external parent
                        if is_empty_orap or is_external_parent:
                            r = root['0'] + 1
                    ...
                    for i in range(len(df)):
                        ...
                        if orap_value and orap_value != app_number != '':
                            ...
                            fallback_root = {
                                ...
                                'root_orap': get_first_orap(current_row['orap']) if pd.notna(current_row['orap']) else '',
